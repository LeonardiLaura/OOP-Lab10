...
public class ConcurrentGUI {
    ...
    //private final ExecutorService exe = new AbstractExecutorService();
    ...
    private class Agent implements Runnable {
        ...
        public void run() {
            while (!this.stop) {
                try {
                    SwingUtilities.invokeAndWait(() -> ConcurrentGUI.this.label.setText(Integer.toString(this.counter)));
                    if (this.dirUp) {
                        this.counter++;
                    } else {
                        this.counter--;
